...
# k-means - setup:
#objaśnienie do robią parametry w funkcji
"""
...
k_means = KMeans(init = "k-means++", n_clusters = 4, n_init = 12)# czyli init tworzy śroki, c_clusters -określa ile środków, n_init - określa ilość iteracji
#training:
k_means.fit(X)
...
#etyketa dla każego z puntktów:
k_means_labels = k_means.labels_
print(k_means_labels)


# geting cluster centers
